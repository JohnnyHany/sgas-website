...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    nameEn: "Ali Hossam",
    nameAr: "علي حسام",
       roleEn: "Vice President & Co-Founder",
    roleAr: "نائب الرئيس والمؤسس المشارك",
    bioEn: "Co-Founder and Vice President of SGAS. Plays a key role in strategic planning and overseeing all SGAS operations and initiatives alongside the founder.",
    bioAr: "المؤسس المشارك ونائب رئيس SGAS. يلعب دور رئيسي في التخطيط الاستراتيجي والإشراف على جميع عمليات ومبادرات SGAS بجانب المؤسس.",
    university: "cairo",
    image: "/team-ali.png",
    icon: Shield,
  ...
  },
  {
    ...
    nameAr: "محمد عبد الكافي",
        roleEn: "Academic Supporter",
    roleAr: "الداعم الأكاديمي",
    bioEn: "Supports the academic division at SGAS by managing study materials, organizing academic workshops, and assisting students with their coursework and professional exam preparation.",
    bioAr: "يدعم القسم الأكاديمي في SGAS من خلال إدارة المواد الدراسية، تنظيم ورش العمل الأكاديمية، ومساعدة الطلاب في دراستهم واستعدادهم للامتحانات المهنية.",
    university: "cairo",
